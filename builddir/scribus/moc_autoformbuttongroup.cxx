...
static const char qt_meta_stringdata_AutoformButtonGroup[] = {
    "AutoformButtonGroup\0FormSel(int,int,qreal*)\0"
    ",,\0\0buttonClicked(int)\0selForm(int)\0"
    "a\0languageChange()\0"
};
...
const QMetaObjectExtraData AutoformButtonGroup::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject AutoformButtonGroup::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_AutoformButtonGroup,
      qt_meta_data_AutoformButtonGroup, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AutoformButtonGroup::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AutoformButtonGroup))
