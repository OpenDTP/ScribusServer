...
#include "../../scribus/aboutplugins.h"
...
static const char qt_meta_stringdata_AboutPlugins[] = {
    "AboutPlugins\0displayPlugin(QListWidgetItem*)\0"
    "item\0\0"
};
...
void AboutPlugins::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->displayPlugin((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData AboutPlugins::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject AboutPlugins::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AboutPlugins,
      qt_meta_data_AboutPlugins, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AboutPlugins::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AboutPlugins))
