...
static const char qt_meta_stringdata_MergeDoc[] = {
    "MergeDoc\0changeFile()\0\0checkDestPageStatus(int)\0"
    "positionComboSelection\0enableCreateWidgets()\0"
};
...
const QMetaObjectExtraData MergeDoc::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MergeDoc::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MergeDoc,
      qt_meta_data_MergeDoc, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MergeDoc::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MergeDoc))
