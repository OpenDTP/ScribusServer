...
static const char qt_meta_stringdata_PrefsPanel[] = {
    "PrefsPanel\0apply()\0\0"
};
...
const QMetaObjectExtraData PrefsPanel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PrefsPanel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PrefsPanel,
      qt_meta_data_PrefsPanel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PrefsPanel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PrefsPanel))
