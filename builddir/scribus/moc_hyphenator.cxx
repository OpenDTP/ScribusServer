...
static const char qt_meta_stringdata_Hyphenator[] = {
    "Hyphenator\0slotNewSettings(int,bool,bool,int)\0"
    "Wordlen,Autom,ACheck,Num\0\0"
    "slotHyphenateWord(PageItem*,QString,int)\0"
    "it,text,firstC\0slotHyphenate(PageItem*)\0"
    "it\0slotDeHyphenate(PageItem*)\0"
};
...
const QMetaObjectExtraData Hyphenator::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Hyphenator::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Hyphenator,
      qt_meta_data_Hyphenator, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Hyphenator::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Hyphenator))
