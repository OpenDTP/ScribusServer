...
#include "../../scribus/smcstylewidget.h"
...
static const char qt_meta_stringdata_SMCStyleWidget[] = {
    "SMCStyleWidget\0slotColorChange()\0\0"
};
...
const QMetaObjectExtraData SMCStyleWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SMCStyleWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SMCStyleWidget,
      qt_meta_data_SMCStyleWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SMCStyleWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SMCStyleWidget))
