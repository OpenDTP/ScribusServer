...
#include "../../scribus/colorlistbox.h"
...
static const char qt_meta_stringdata_ColorListBox[] = {
    "ColorListBox\0languageChange()\0\0"
};
...
const QMetaObjectExtraData ColorListBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ColorListBox::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_ColorListBox,
      qt_meta_data_ColorListBox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ColorListBox::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ColorListBox))
