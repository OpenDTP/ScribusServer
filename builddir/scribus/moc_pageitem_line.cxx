...
static const char qt_meta_stringdata_PageItem_Line[] = {
    "PageItem_Line\0"
};
...
const QMetaObjectExtraData PageItem_Line::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PageItem_Line::staticMetaObject = {
    { &PageItem::staticMetaObject, qt_meta_stringdata_PageItem_Line,
      qt_meta_data_PageItem_Line, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PageItem_Line::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PageItem_Line))
