...
static const char qt_meta_stringdata_SampleItem[] = {
    "SampleItem\0"
};
...
const QMetaObjectExtraData SampleItem::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SampleItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SampleItem,
      qt_meta_data_SampleItem, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SampleItem::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SampleItem))
