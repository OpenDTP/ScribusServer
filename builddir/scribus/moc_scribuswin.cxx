...
static const char qt_meta_stringdata_ScribusWin[] = {
    "ScribusWin\0AutoSaved()\0\0slotAutoSave()\0"
};
...
const QMetaObjectExtraData ScribusWin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ScribusWin::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ScribusWin,
      qt_meta_data_ScribusWin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ScribusWin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ScribusWin))
