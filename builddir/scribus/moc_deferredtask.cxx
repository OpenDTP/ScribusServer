...
static const char qt_meta_stringdata_DeferredTask[] = {
    "DeferredTask\0aborted(bool)\0\0finished()\0"
    "progress(int)\0start()\0runUntilFinished()\0"
    "cancel()\0next()\0"
};
...
const QMetaObjectExtraData DeferredTask::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DeferredTask::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DeferredTask,
      qt_meta_data_DeferredTask, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DeferredTask::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DeferredTask))
