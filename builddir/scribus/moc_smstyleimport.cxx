...
#include "../../scribus/smstyleimport.h"
...
static const char qt_meta_stringdata_SMStyleImport[] = {
    "SMStyleImport\0checkAll(bool)\0allChecked\0"
    "\0"
};
...
const QMetaObjectExtraData SMStyleImport::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SMStyleImport::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SMStyleImport,
      qt_meta_data_SMStyleImport, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SMStyleImport::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SMStyleImport))
