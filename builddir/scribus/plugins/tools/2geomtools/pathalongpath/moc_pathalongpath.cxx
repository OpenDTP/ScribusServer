...
static const char qt_meta_stringdata_PathAlongPathPlugin[] = {
    "PathAlongPathPlugin\0"
    "updateEffectG(int,double,double,double,int)\0"
    "effectType,offset,offsetY,gap,rotate\0"
    "\0updateEffect(int,double,double,double,int)\0"
};
...
const QMetaObjectExtraData PathAlongPathPlugin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PathAlongPathPlugin::staticMetaObject = {
    { &ScActionPlugin::staticMetaObject, qt_meta_stringdata_PathAlongPathPlugin,
      qt_meta_data_PathAlongPathPlugin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PathAlongPathPlugin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PathAlongPathPlugin))
