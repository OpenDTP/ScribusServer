...
static const char qt_meta_stringdata_LensEffectsPlugin[] = {
    "LensEffectsPlugin\0"
};
...
const QMetaObjectExtraData LensEffectsPlugin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LensEffectsPlugin::staticMetaObject = {
    { &ScActionPlugin::staticMetaObject, qt_meta_stringdata_LensEffectsPlugin,
      qt_meta_data_LensEffectsPlugin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LensEffectsPlugin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LensEffectsPlugin))
