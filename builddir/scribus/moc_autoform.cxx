...
static const char qt_meta_stringdata_Autoforms[] = {
    "Autoforms\0FormSel(int,int,qreal*)\0,,\0"
    "\0selForm(int)\0a\0"
};
...
const QMetaObjectExtraData Autoforms::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Autoforms::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_Autoforms,
      qt_meta_data_Autoforms, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Autoforms::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Autoforms))
