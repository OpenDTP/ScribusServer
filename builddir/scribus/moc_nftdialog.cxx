...
static const char qt_meta_stringdata_nftdialog[] = {
    "nftdialog\0enableButtonBox(bool)\0\0"
};
...
const QMetaObjectExtraData nftdialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject nftdialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_nftdialog,
      qt_meta_data_nftdialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &nftdialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_nftdialog))
