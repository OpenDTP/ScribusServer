...
static const char qt_meta_stringdata_Private_Signal[] = {
    "Private_Signal\0changedObject(QObject*)\0"
    "what\0\0changedData(QVariant)\0"
};
...
const QMetaObjectExtraData Private_Signal::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Private_Signal::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Private_Signal,
      qt_meta_data_Private_Signal, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Private_Signal::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Private_Signal))
