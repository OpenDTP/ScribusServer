...
static const char qt_meta_stringdata_ActionManager[] = {
    "ActionManager\0languageChange()\0\0"
    "handleMultipleSelections(bool)\0"
    "isMultiple\0"
};
...
const QMetaObjectExtraData ActionManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ActionManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ActionManager,
      qt_meta_data_ActionManager, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ActionManager::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ActionManager))
