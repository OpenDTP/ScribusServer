...
static const char qt_meta_stringdata_CollectForOutput[] = {
    "CollectForOutput\0"
};
...
const QMetaObjectExtraData CollectForOutput::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CollectForOutput::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CollectForOutput,
      qt_meta_data_CollectForOutput, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CollectForOutput::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CollectForOutput))
