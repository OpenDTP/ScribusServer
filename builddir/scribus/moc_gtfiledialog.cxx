...
#include "../../scribus/gtfiledialog.h"
...
static const char qt_meta_stringdata_gtFileDialog[] = {
    "gtFileDialog\0accept()\0\0"
};
...
const QMetaObjectExtraData gtFileDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject gtFileDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_gtFileDialog,
      qt_meta_data_gtFileDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &gtFileDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_gtFileDialog))
