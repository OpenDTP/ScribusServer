...
#include "../../scribus/multipleduplicate.h"
...
static const char qt_meta_stringdata_MultipleDuplicate[] = {
...
const QMetaObjectExtraData MultipleDuplicate::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MultipleDuplicate::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MultipleDuplicate,
      qt_meta_data_MultipleDuplicate, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MultipleDuplicate::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MultipleDuplicate))
